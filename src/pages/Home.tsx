...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-40 pb-32 px-6 min-h-screen flex items-center grid-bg">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase tracking-tight leading-[1.1] text-text-main mb-8 whitespace-nowrap">
              Sovereign <span className="text-accent-blue font-light mx-2">|</span> Business <span className="text-accent-blue font-light mx-2">|</span> AI
            </h1>
            <p className="font-body text-lg md:text-xl text-text-main/80 max-w-2xl leading-relaxed mb-12 border-l-2 border-accent-blue pl-6 shadow-[-4px_0_15px_-5px_rgba(59,130,246,0.2)]">
              The ARC Engine: A bespoke AI ecosystem engineered for the enterprise perimeter. Creating controlled velocity in revenue and cost to drive margin expansion.
            </p>
            <div className="flex flex-col sm:flex-row gap-6">
              <Link to="/identity" className="bg-accent-blue text-white font-display font-bold uppercase tracking-widest px-8 py-4 hover:bg-white hover:text-obsidian transition-colors flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:shadow-[0_0_30px_rgba(255,255,255,0.6)] rounded-sm">
      ...
      <section className="py-32 px-6 relative border-t border-white/5 bg-obsidian/80 backdrop-blur-sm">
